    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="absolute top-0 left-0 right-0 h-[30vh] -z-10 overflow-hidden">
        <div
          ...
          style={{
            background: "radial-gradient(ellipse, #C8A97E, transparent 70%)",
            filter: "blur(80px)",
          }}
        />
      </div>
      ...
      <article className="max-w-3xl mx-auto px-5 sm:px-8 pt-8 pb-20">
        ...
        <motion.div
          ...
          className="prose prose-invert prose-sm max-w-none
            ...
            prose-code:text-gold/70 prose-code:bg-foreground/[0.04] prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:text-[13px]
            prose-pre:bg-[#141414] prose-pre:border prose-pre:border-foreground/[0.04] prose-pre:rounded-xl
